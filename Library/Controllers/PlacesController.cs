...
namespace Library.Controllers
{
    public class PlacesController : Controller
    {
        ...
        {
            var placeContext = _context.Places.Include(p => p.Book);
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["BookId"] = new SelectList(_context.Books, "Id", "Id", place.BookId);
            return View(place);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Stand,Shelf,Number,BookId")] Place place)
        {
            if (id != place.Id)
            {
                return NotFound();
