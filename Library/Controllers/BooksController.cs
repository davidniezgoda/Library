...
namespace Library.Controllers
{
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,PublishmentYear,ISBN,Genre,AuthorId")] Book book)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,PublishmentYear,ISBN,Genre,AuthorId")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
